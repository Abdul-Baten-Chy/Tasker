...
function AddTask({ onSave, selectedTask, handleClose }) {
  ...
  return (
    <>
      ...
      >
        ...
        <div class="mt-16 flex justify-center gap-4 lg:mt-20">
          <button class="rounded bg-blue-600 px-4 py-2 text-white transition-all hover:opacity-80">
            {isEdit ? "Create new Task" : "Save Edit"}
          </button>
          <button
            onClick={handleClose}
            class="rounded bg-red-600 px-4 py-2 text-white transition-all hover:opacity-80"
          >
            close
          </button>
        </div>
